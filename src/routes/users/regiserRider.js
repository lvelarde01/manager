      ...
      <div className='row d-flex align-items-center justify-content-center vh-100 vw-100 '>
          ...
          <div className={`col-10 ms-3 me-3 block-radius-style ${Auth.theme || theme}-style`}>
                    ...
                    <Form className='ms-3 me-3 mt-4' method='post' onSubmit={handlerOnSubmit}  >
                      ...
                      <div className="mb-3">
                        <h2>REGISTRO DE RIDER</h2>
                      </div>
                      <legend>DETALLE DEL CONDUCTOR</legend>
                        <InputCustom  placeholderField={'DNI O NIE'} nameField={'company_ssid'} parentClassname={'col mb-3'} errorsField={errors} setErrorField = {setErrors} />
                        ...
                        <InputCustom  placeholderField={'PERMISO DE CONDUCIR'} min={9} max={9} nameField={'company'} parentClassname={'col mb-3'} errorsField={errors} setErrorField = {setErrors} />
