...
export function Index() {
  ...
  useEffect(()=>{
    if(loadingData)return;
      ...
      const dataReceived = await ActionFetch({},'/api/container/list');
      ...
      <table className="table table-hover ">
          <thead>
            <tr>
              ...
              <th scope="col">Pcs</th>
              <th scope="col">Pre-Planing</th>
              <th scope="col">PPL/Unloaded</th>
              <th scope="col">UNL time</th>
              <th scope="col">Counted hrs</th>
              <th scope="col">PPL Counted</th>
              <th scope="col">Staging Pallets</th>
              <th scope="col">PPL Forklift</th>
          ...
          <tbody>
            {dataRowShow&&dataRowShow.map((data)=>(
                ...
                <td>{data.name}</td>
                <td>{data.preplaning}</td>
                <td>{data.ppl_unloaded}</td>
                <td>{data.name}</td>
                <td>{data.counted_hours}</td>
                <td>{data.ppl_counted}</td>
                <td>{data.stagung_pallets}</td>
