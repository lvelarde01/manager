...
export default function SelectCustom({
  ...
  return (
        <div className={parentClassname}>
          <label htmlFor={labelSelectid} style={{fontSize:'11px',color:'rgb(35 108 90)',fontWeight:'bold'}}>{inputValue&&placeholderField} {errorsField?.[nameField] &&<strong style={{color:'#dc3545'}}>*</strong>}</label>
