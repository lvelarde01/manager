...
export default function InputCustom({
  ...
  return (
        <div className={parentClassname}>
          <label style={{fontSize:'11px',color:'rgb(35 108 90)',fontWeight:'bold'}}>{inputValue&&placeholderField} {errorsField?.[nameField] &&<strong style={{color:'#dc3545'}}>*</strong>}</label>
